...
function defaultState(){
  ...
  return{
    version:"4.4-r7",activeBranch:"mile",target:"jetblack",customTarget:"",
...
function backupFile(){var payload=clone(state);payload.backupMeta={version:"4.4-r7",createdAt:new Date().toISOString(),target:targetName(),skills:selectedSkillNames().length};return new File([JSON.stringify(payload,null,2)],"ウマ娘自動因子設計_v44r7_バックアップ.json",{type:"application/json"})}
