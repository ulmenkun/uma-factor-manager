...
// Ver.4.4 r5: 技能試験用スキル値の再検証。保存済み/オンライン更新パックより後に必ず補正する。
...
function defaultState(){
  ...
  return{
    version:"4.4-r5",activeBranch:"mile",target:"jetblack",customTarget:"",
...
function backupFile(){var payload=clone(state);payload.backupMeta={version:"4.4-r5",createdAt:new Date().toISOString(),target:targetName(),skills:selectedSkillNames().length};return new File([JSON.stringify(payload,null,2)],"ウマ娘自動因子設計_v44r5_バックアップ.json",{type:"application/json"})}
